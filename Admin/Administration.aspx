...
<div class="formDivs">
       <asp:GridView ID="GridView1" runat="server" CellPadding="2" ForeColor="#333333" 
            GridLines="None" Width="792px" AllowPaging="True" AllowSorting="True" 
            AutoGenerateColumns="False" DataSourceID="dsorder" 
                BorderColor="Black" BorderStyle="Solid" BorderWidth="3px" Height="170px">
            ...
            <HeaderStyle BackColor="#00112D" Font-Bold="True" ForeColor="White" />
            <PagerStyle BackColor="#00112D" ForeColor="White" HorizontalAlign="Center" />
...
<div class="formDivs" style="height: 64px; font-weight: bold; text-align:right">
    Please click on &quot;Print To Excel&quot; button to view the full report.&nbsp;&nbsp;<asp:Button 
        ID="Button3" runat="server" Text="Print To Excel" />
    &nbsp;</div>
   
    </asp:Panel>
    <asp:Panel ID="Pnldropdowns" runat="server" Visible="False" Height="285px">
<div class="formDivs">
...
<div class="formDivs">
	...
	<div class="formDivs">
        ...
        &nbsp;<asp:DropDownList
            ...
            <asp:ListItem>COMBO CLASS</asp:ListItem>
        </asp:DropDownList>
        &nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="formDivs">
    <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" 
        ...
        <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
        <HeaderStyle BackColor="#00112D" Font-Bold="True" ForeColor="White" />
        <PagerStyle BackColor="#00112D" ForeColor="#333333" HorizontalAlign="Center" />
        <RowStyle BackColor="#CCCCCC" ForeColor="#333333" />
        <SelectedRowStyle BackColor="#FFCC66" Font-Bold="True" ForeColor="Navy" />
        <SortedAscendingCellStyle BackColor="#FDF5AC" />
        <SortedAscendingHeaderStyle BackColor="#4D0000" />
