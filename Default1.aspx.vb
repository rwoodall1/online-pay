        ...
        If Page.IsValid Then
            ...
            If cschcode.Length = 5 Then
                selectcmd = "SELECT cust.schname, schaddr, schaddr2, schcity,schstate, schzip," _
                  & "schphone,cust.schcode, schfax,invno,basicinvamt,persinvamt,basiconly,yr,ponum,onlinecuto,adcuto,picpers,picpersamt,inkpers,inktxt,inktxtamt,foilpers,inkpersamt,foilpersamt, foiltxtamt,foiltxt,luvlines,luvlineamt,adline,fulladlineamt,halfadlineamt,quarteradlineamt,eighthadlineamt  " _
                ...
                Dim luvlineamt As String = ""
                Dim adline As Boolean = 0
                Dim fulladline As String = ""
                Dim halfadline As String = ""
                Dim quarteradline As String = ""
                Dim eightadline As String = ""
                Dim adcuto As Date = Today.Date
                ...
                For Each drvSql In dvSql
                    ...
                    luvlineamt = drvSql("luvlineamt").ToString
                    fulladline = drvSql("fulladlineamt").ToString
                    halfadline = drvSql("halfadlineamt").ToString
                    quarteradline = drvSql("quarteradlineamt").ToString
                    eightadline = drvSql("eighthadlineamt").ToString
                    Try
                        onlinecuto = drvSql("onlinecuto")
                        adcuto = drvSql("adcuto")
                    Catch ex As Exception

                    End Try
                    Try
                        adline = drvSql("adline")
                ...
                ShopCart.AdLine = adline
                ShopCart.FullAdLineAmt = fulladline
                ShopCart.HalfAdLineAmt = halfadline
                ShopCart.QuarterAdLineAmt = quarteradline
                ShopCart.EightAdLineAmt = eightadline
