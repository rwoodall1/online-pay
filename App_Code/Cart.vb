...
Public Class Cart
    ...
    Private vadline As Boolean = 0
    Private vfulladlineamt As String = ""
    Private vhalfadlineamt As String = ""
    Private vquarteradlineamt As String = ""
    Private veightadlineamt As String = ""
    Private vadcuto As Date
    Dim vyr As String = ""
	'Private objDR As System.Data.DataRow
	Private vxmltable As String = ""

#Region "Properties"
    Public Property Adcuto As Date     'xmlstring
        Get
            Return vadcuto
        End Get
        ...
        End Set
    End Property
    Public Property AdLine As Boolean     'xmlstring
        Get
            Return vadline
        End Get
        ...
        End Set
    End Property
    Public Property FullAdLineAmt As String      'xmlstring
        Get
            Return vfulladlineamt
        End Get
        Set(ByVal Value As String)
            vfulladlineamt = Value
        End Set
    End Property
    Public Property HalfAdLineAmt As String      'xmlstring
        Get
            Return vhalfadlineamt
        End Get
        Set(ByVal Value As String)
            vhalfadlineamt = Value
        End Set
    End Property
    Public Property QuarterAdLineAmt As String
        Get
            Return vquarteradlineamt
        End Get
        Set(ByVal Value As String)
            vquarteradlineamt = Value
        End Set
    End Property
    Public Property EightAdLineAmt As String
        Get
            Return veightadlineamt
        End Get
        Set(ByVal Value As String)
            veightadLineamt = Value
        End Set
    End Property

    Public Property LuvLineAmt As String
        Get
            Return vluvlineamt
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Public Property LuvLine As Boolean
        Get
            Return vluvline
        End Get
        Set(ByVal Value As Boolean)
    ...
    Public Property picpersamt As String
        Get
            Return vpicpersamt
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Public Property inkpersamt As String
        Get
            Return vinkpersamt
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Public Property foilpersamt As String
        Get
            Return vfoilpersamt
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Public Property foiltxtamt As String
        Get
            Return vfoiltxtamt
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Public Property foiltxt As Boolean
        Get
            Return vfoiltxt
        End Get
        Set(ByVal Value As Boolean)
        ...
        End Set
    End Property
    Public Property inktxt As Boolean
        Get
            Return vinktxt
        End Get
        Set(ByVal Value As Boolean)
        ...
        End Set
    End Property
    Public Property inktxtamt As String
        Get
            Return vinktxtamt
        End Get
        Set(ByVal Value As String)
    ...
    Public Property picpers As Boolean
        Get
            Return vpicpers
        End Get
        Set(ByVal Value As Boolean)
        ...
        End Set
    End Property
    Public Property foilpers As Boolean
        Get
            Return vfoilpers
        End Get
        Set(ByVal Value As Boolean)
        ...
        End Set
    End Property
    Public Property inkpers As Boolean
        Get
            Return vinkpers
        End Get
        Set(ByVal Value As Boolean)
